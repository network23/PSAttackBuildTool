_PS>Attack isn't in a working state yet, [PSPunch](https://www.github.com/jaredhaight/PSPunch/) (the portable environment that PS>Attack generates) works as a limited proof of concept. You can download the alpha for PSPunch [here](https://github.com/jaredhaight/PSPunch/releases/)_
